...
<!-- Navbar -->
<div class="w3-top">
    <div class="w3-theme-green w3-bar w3-left-align w3-large">
        <a class="w3-theme-green w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-padding-large w3-hover-white w3-large" href="javascript:void(0);" onclick="openNav()"><i class="fa fa-bars"></i></a>
        <a href="" style="position:fixed; left:192px" class="w3-theme-green w3-bar-item w3-button w3-padding-large"><i class="fa fa-home w3-margin-right"></i>Quora</a>
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m3">
            ...
            <div class="w3-card w3-round">
                <div style="position: fixed; height :180px; width: 240px; top:60px" class="w3-white">
        ...
        <div style="position: absolute;left: 450px; width: 700px; top: 45px" class="w3-col m7">
            ...
            <% List<Question> questionsOfOtherUsers = (List<Question>) request.getAttribute("questionsOfOtherUsers"); %>
            <% for(Question question : questionsOfOtherUsers) { %>
            <form name="form" method="post">
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <button formaction="/home/answerQuestion-<%=question.getQuestionID()%>" type="submit" class="w3-button w3-theme-green w3-margin-bottom"><i class="fa fa-comment"></i> &nbsp;Answer</button>
                </div>
            </form>
            <% } %>
...
<footer style="position: fixed; width:1366px; height: 45px; bottom: 0px" class="w3-container w3-theme-green">
