...
<div class="w3-container w3-content" style="max-width:1000px;margin-top:60px">
    ...
    <div class="w3-row">
        ...
        <% List<User> followerOfCurrentUser = (List<User>) request.getAttribute("followerOfCurrentUser"); %>
        <% for(User follower : followerOfCurrentUser) { %>
        <!-- Column -->
        <div class="w3-col m3">
            <!-- Profile -->
            <div class="w3-card w3-round w3-white w3-margin">
                <div class="w3-container">
                    <a href="/home/profile/<%=follower.getName()%>-<%=follower.getSurname()%>"><h4 class="w3-center"><%=follower.getName()%> <%=follower.getSurname()%></h4></a>
                    <p class="w3-center"><img src="<%=follower.getPhoto()%>" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
                    <hr>
                    <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> <%=follower.getJob()%></p>
                    <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> <%=follower.getCity()%></p>
                    <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> <%=follower.getBirthday()%></p>
                </div>
            </div>
            <br>
            <!-- End Column -->
...
<!-- Footer -->
<footer style="position: fixed; width:1366px; height: 45px; bottom: 0px" class="w3-theme-pink w3-container">
